...
initialWorldModelSpec =
    ...
    , entity "LEEPOLICEOFFICE.npc.day=1.trigger=0"
        "Lee"
        "Well, Allen seems to be looking for you. Let's go."
    , entity "BOBPOLICEOFFICE.npc.day=1.trigger=0"
        "Bob"
        "Don't disturb me. I'm reading something."
    , entity "ALLENPOLICEOFFICE.npc.day=1.trigger=0"
        "Allen"
        "A man who loves reading novels."
    , entity "ALLENPARK.npc.day=1.trigger=0"
        "Allen"
        "Go to ask them about this case. Lee told me that Brennan died at 9 p.m. yesterday. Once you have come to a conclusion, click the top-left button, make your choice and then you can go home for sleep."
    ...
    , entity "CATHERINE.npc.day=1.trigger=0.suspect=0"
        "Catherine"
        "Do find out the truth... I can't take it. We were about to get engaged and then he died suddenly..."
    ...
    , entity "ALLENPOLICEOFFICEDAY2.npc.day=2.trigger=3"
        "Allen"
        "What are you waiting for? Go to the reporter's house!"
    ...
    , entity "LEEJOURNALISTHOMEDAY2.npc.day=2.trigger=2"
        "Lee"
        "Well, It seems that we should wait for forensic for further report about his death and before that, let's discover whether there exists other evidence in his home. You know, the instructions from above, Mr. Boss. \n \n Tutorial: There may exist places hiding some evidence in the map. Go around the house and press X near the desk."
    , entity "EVIDENCEJONALI.evidence.day=2.trigger=2"
        "Evidence on journalist's desk"
        "\"Hurry up, bro! Let's back to the office!\" Lee is calling you. Alas, you can't take more, or your behavior will be exposed."
    ...
    , entity "PILLS.trigger=2"
        "pills"
        "A Bottle containing many pills, on which a tag saying \"Διόνυσος\", the next line is \"PARADISE Co.Ltd\"."
    ...
    , entity "FALSE_MEM_CARD_CONTENT.trigger=4"
        "false mem card"
        "Hey, it's all about me! Who shot all these...? Bad feeling... I think it's bad for me. Maybe I should discard it. \n \n \n \n Tutorial: You can discard items that you think harmful."
    , entity "BANK_CARD_EVI.trigger=0"
        "bankcard"
        "A bank card with the name of the holder is Stallworth. It is a fairly new diamond card with card number 1000001."
    , entity "DAGGER2_EVI.trigger=1"
        "dagger2"
        "A dagger with weird letters on it. Seems that it's part of some couple souvenir."
 ...
 ---- evidence choices
    ...
    , entity "PAYATTENTION.leetalk.choices=0"
        "Oh, I'll pay attention the next time."
        ""
    ...
    , entity "ADKINSALIBI.choices=0"
        "Where were you last night, Adkins? Were you with someone else?"
        ""
    , entity "CATHERINEALIBI.choices=0"
        "Where were you last night, Catherine? Were you with someone else?"
        ""
    ...
    , entity "DISGUISEFEAR.day2.choices=0"
        "( You are too shocked to utter a word; but you don't know why. ) "
        ""
    ...
    , entity "ASK_LEE_WHY.day2.choices=0"
        "What? Why someone will commit suicide in such cruel way? And why the conclusion is made so hurriedly? Can I have a look at the report of the autopsy?"
        ""
    --- day2night
    ...
    , entity "COFFEE_NORMAL.trigger=0"
        ...
        "You have a cup of coffee. Frankly speaking, the coffee offered here is too bitter. But you never tell anybody."
...
---- day7
    , entity "PHONE_DAY7.trigger=0"
        "phone council"
        "It's night now. The game is afoot! Time to have a hunt for evidence in Jonathon's office!"
...
narrative_content =
    Dict.empty
        ...
        |> content__________________________________ "talk with allen park"
            "{ALLENPARK.trigger=1? Go to ask them about this case. Lee has told me that Brennan died about 9 p.m. yesterday. Once you have come to a conclusion, click the top-left button, make your choice and then you can go home for sleep.| What do you think about this? What looks suspicious?}"
        ...
        |> content__________________________________ "talk with allen park 2"
            "Do you think there's anything questionable about them? Let me know if you come to a conclusion on this case, and we trust your judgment, Kay. \n \n \n \n Tutorial: Click the top-left button to make your choice."
        ...
        |> content__________________________________ "lee order you check body"
            "Oh, Kay, you arrived! The body is there, you can check it. \n \n \n \n Tutorial: There may exist items available for interaction in maps. Go near the bedside and press X. See what happens."
        ...
        |> content__________________________________ "headache3"
            "Well, now calm down a little anyway. Then I should talk with Lee again."
        ...
        |> content__________________________________ "waiting1"
            "Playing... Press X to continue playing"
