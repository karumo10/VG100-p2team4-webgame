...
initialWorldModelSpec =
    ...
    , entity "ALLENPARK.npc.day=1.trigger=0"
        "Allen"
        "Go to ask them about this case. Lee has told me that Brennan died about 9 p.m. yesterday. Once you have come to a conclusion, click the top-left button, make your choice and then you can go home for sleep."
