...
renderhelp =
    ...
    ,Html.nav [class "navhelp"] [div [class "container"]
                                     [div [ style "font-family" "Helvetica, Arial, sans-serif"
                                          ...
                                          , Html.br [] []
                                          , p [] [ text "Use '↑', '↓', '←', '→' to move." ]
                                          , p [] [ text "You cannot move if you run into an obstacle. Around it." ]
                                          ...
                                          , p [] [ text "If you need to decide who is the murderer, please go to the suspect list (top left corner)."]
                                          , p [] [ text "You can see the items you have got in your bag (top right corner). You can examine or discard items in you home. Pay attention that you can not get the items again if you discard it."]
