...
wakeUp model =
    ...
    in
    if day == 8 then
    { model_ | story = story, day = day, energy = energy, dayState = dayState, energy_Full = energy_Full, isTeleportedToCouncil = False, npcs_all = npcs ++ [courtFinal] }
    else if day == 6 then
    { model_ | story = story, day = day, energy = energy, dayState = dayState, energy_Full = energy_Full, isTeleportedToCouncil = False, npcs_all = npcs ++ [courtSpeaker] }
    else
